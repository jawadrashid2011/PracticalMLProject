...
Next, rPart with 10-fold cross validation was used. The model was trained using **train** function with all default values. The model took only **seconds** to train.
...
fancyRpartPlot(rPartModel$finalModel, main="rPart Tree")
```
